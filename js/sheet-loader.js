...
// Track loading
var _sheetLoaded = {photos:false, schedule:false, programs:false, quotes:false};
var _sheetCallbacks = [];
...
function _checkAllLoaded(){
  if(_sheetLoaded.photos && _sheetLoaded.schedule && _sheetLoaded.programs && _sheetLoaded.quotes){
